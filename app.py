        ...
        if not selected_station.empty:
            ...
            with col1:
                ...
                st.metric(
                    ...
                    round(
                        station_info["avg_bikes_available"],
                        2
                    )
                )
...
st.header("📊 Station Demand Analysis")
...
selected = station_analysis[
    station_analysis["start_station"] == selected_station_view
]
...
st.header("🚚 Recommended Bike Redistribution")

st.write(
    "Recommended movement of bikes from surplus stations "
    "to stations with higher shortage pressure."
)
